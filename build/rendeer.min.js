'use strict';(function(A){function f(a){if(this.constructor!==e.SceneNode)throw"You must use new to create RD.SceneNode";this._ctor();a&&this.configure(a)}function s(a){this._ctor();a&&this.configure(a)}function u(){this._root=new e.SceneNode;this._root.flags.no_transform=!0;this._root._scene=this;this._nodes_by_id={};this._to_destroy=[];this.frame=this.time=0}function k(a,b){b=b||{};var c=this.gl=this.context=a;if(!c||!c.enable)throw"litegl GL context not found.";a!=A.gl&&c.makeCurrent();this.point_size=
5;this.sort_by_priority=!0;this.sort_by_distance=!1;this.assets_folder="";this._view_matrix=mat4.create();this._projection_matrix=mat4.create();this._viewprojection_matrix=mat4.create();this._mvp_matrix=mat4.create();this._model_matrix=mat4.create();this._nodes=[];this._uniforms={u_view:this._view_matrix,u_viewprojection:this._viewprojection_matrix,u_model:this._model_matrix,u_mvp:this._mvp_matrix,u_global_alpha_clip:0};A.gl=this.gl;this.canvas=c.canvas;this.assets_folder=b.assets_folder||"";this.autoload_assets=
...
a.far),a.fov&&(this.fov=a.fov),a.aspect&&(this.aspect=a.aspect));this.updateMatrices()}function y(a,b){return vec3.dot(a,b)+a[3]}function z(a,b,c){var d=a[3],g=Math.abs(c[0]*a[0]),p=Math.abs(c[1]*a[1]);c=Math.abs(c[2]*a[2]);g=g+p+c;a=vec3.dot(a,b)+d;return a<=-g?n:a<=g?C:D}function r(){this._ctor()}function w(){this._ctor();this.points=[];this.max_points=1E3;this.draw_range=[0,3*this.max_points];this.shader="pointcloud";this.textures={color:"white"};this.blend_mode=e.BLEND_ALPHA;this.flags.depth_write=
...
Object.defineProperty(f.prototype,"scene",{get:function(){return this._scene},set:function(a){throw"cannot set scene, you must use addChild in its parent node";},enumerable:!1});Object.defineProperty(f.prototype,"parentNode",{get:function(){return this._parent},set:function(a){throw"Cannot set parentNode of SceneNode";},enumerable:!1});f.prototype.addChild=function(a){function b(a,d){a._scene=d;a.id&&d&&(d._nodes_by_id[a.id]=a);for(var g=0,p=a.children.length;g<p;g++)b(a.children[g],d)}if(a._parent)throw"addChild: Cannot add a child with a parent, remove from parent first";
a._parent=this;this.children.push(a);b(a,this._scene)};f.prototype.removeChild=function(a){function b(a){a.id&&a._scene&&a._scene._nodes_by_id[a.id]&&delete a._scene._nodes_by_id[a.id];a._scene=null;for(var c=0,p=a.children.length;c<p;c++)b(a.children[c])}if(a._parent!=this)throw"removeChild: Not its children";var c=this.children.indexOf(a);if(-1==c)throw"removeChild: impossible, should be children";this.children.splice(c,1);a._parent=null;b(a)};f.prototype.removeAllChildren=function(){for(;this.children.length;)this.removeChild(this.children[0])};
f.prototype.clear=function(){for(;this.children.length;)this.removeChild(this.children[this.children.length-1])};f.prototype.setChildIndex=function(a,b){var c=this.children.indexOf(a);-1!=c&&(this.children.splice(c,1),this.children.splice(b,0,a))};f.prototype.getAllChildren=function(a){a=a||[];for(var b=0,c=this.children.length;b<c;b++){var d=this.children[b];a.push(d);d.getAllChildren(a)}return a};f.prototype.getVisibleChildren=function(a,b){a=a||[];void 0===b&&(b=255);if(!1===this.flags.visible)return a;
for(var c=0,d=this.children.length;c<d;c++){var g=this.children[c];g.layers&b&&a.push(g);g.getVisibleChildren(a,b)}return a};f.prototype.serialize=function(){for(var a={position:[this._position[0],this._position[1],this._position[2]],rotation:[this._rotation[0],this._rotation[1],this._rotation[2],this._rotation[3]],scale:[this._scale[0],this._scale[1],this._scale[2]],children:[]},b=0,c=this.children.length;b<c;b++)a.children.push(this.children[b].serialize());return a};f.prototype.configure=function(a){var b=
null,c;for(c in a){switch(c){case "children":continue;case "uniforms":for(var d in a.uniforms)this.uniforms[d]=a.uniforms[d];continue;case "texture":this[c]=a[c];continue;case "scale":case "scaling":this.scale(a[c]);continue;case "parent":b=a[c];continue}var g=this[c];void 0!==g&&(g&&g.constructor===Float32Array?g.set(a[c]):this[c]=a[c])}this._must_update_matrix=!0;this.updateGlobalMatrix();if(a.children)for(c=0;c<a.children.length;++c)console.warn("configure children: feature not implemented");b&&
(this.parentNode?console.error("This node already has a parent"):b.addChild(this))};f.prototype.setMesh=function(a){a?"string"==typeof a?this.mesh=a:this._mesh=a:this.mesh=null};f.prototype.setTexture=function(a,b){b?"string"==typeof b&&(this.textures[a]=b):this.textures[a]=null};f.prototype.resetTransform=function(){this._position.set(e.ZERO);quat.identity(this._rotation);this._scale.set(e.ONE);this._must_update_matrix=!0};f.prototype.translate=function(a){vec3.add(this._position,this._position,
a);this._must_update_matrix=!0};f.prototype.rotate=function(a,b,c){quat.setAxisAngle(x,b,a);c?quat.multiply(this._rotation,x,this._rotation):quat.multiply(this._rotation,this._rotation,x);this._must_update_matrix=!0};f.prototype.scale=function(a){a.constructor===Number?(q[0]=q[1]=q[2]=a,vec3.mul(this._scale,this._scale,q)):vec3.mul(this._scale,this._scale,a);this._must_update_matrix=!0};f.prototype.setPivot=function(a){this.pivot=a};f.prototype.orbit=function(a,b,c){if(!b)throw"RD: orbit axis missing";
quat.setAxisAngle(x,b,a);this._must_update_matrix=!0};f.prototype.getLocalMatrix=function(){this._must_update_matrix&&this.updateLocalMatrix();return this._local_matrix};f.prototype.getGlobalMatrix=function(){this.updateGlobalMatrix();return this._global_matrix};f.prototype.getGlobalRotation=function(a){a=a||vec3.create();quat.identity(a);for(var b=this,c=this._scene?this._scene._root:null;b!=c;)quat.multiply(a,b._rotation,a),b=b._parent;return a};f.prototype.updateLocalMatrix=function(){var a=this._local_matrix;
...
function(a,b){b=b||vec3.create();var c=this.getGlobalRotation(x);return vec3.transformQuat(b,a,c)};f.prototype.getDistanceTo=function(a){var b=this.getGlobalMatrix();return vec3.distance(a,b.subarray(12,15))};f.prototype.findNode=function(a){for(var b=0,c=this.children.length;b<c;b++){var d=this.children[b];if(d.id==a||(d=d.findNode(a)))return d}return null};f.prototype.propagate=function(a,b){for(var c=0,d=this.children.length;c<d;c++){var g=this.children[c];g&&(g[a]&&g[a].apply(g,b),g.children&&
g.children.length&&g.propagate(a,b))}};f.prototype.loadTextConfig=function(a,b){GL.request(a,null,function(a){a=e.parseTextConfig(a);b&&b(a)},alert)};f.prototype.destroy=function(a){!this.scene||a?this._parent&&this._parent.removeChild(this):this.scene._to_destroy.push(this)};f.prototype.testRay=function(){var a=vec3.create(),b=vec3.create();vec3.create();vec3.create();vec3.create();mat4.create();mat4.create();return function(c,d,g,p,e){g=void 0===g?Number.MAX_VALUE:g;void 0!==u._ray_tested_objects&&
u._ray_tested_objects++;var f=null,m=null;this.layers&p&&this.mesh&&!this.flags.ignore_collisions&&(m=this.testRayWithMesh(c,a,g,p,e));m&&(m=vec3.distance(c.origin,a),m<g&&(g=m,d.set(a),f=this));if(!this.children&&!this.children.length)return f;for(var h=0;h<this.children.length;++h){var k=this.children[h];k.testRay(c,b,g,p,e)&&(m=vec3.distance(c.origin,b),m<g&&(g=m,d.set(a),f=k))}return f}}();f.prototype.testRayWithMesh=function(){var a=vec3.create(),b=vec3.create(),c=vec3.create(),d=vec3.create(),
g=mat4.create();return function(e,f,t,m,h){t=void 0===t?Number.MAX_VALUE:t;if(!this.mesh)return!1;var k=gl.meshes[this.mesh];if(!k)return!1;var l=k.getBoundingBox();if(!l)return!1;m=this._global_matrix;mat4.invert(g,m);vec3.transformMat4(b,e.origin,g);vec3.add(d,e.origin,e.direction);vec3.transformMat4(d,d,g);vec3.sub(c,d,b);vec3.normalize(c,c);if(!geo.testRayBBox(b,c,l,null,a))return!1;vec3.transformMat4(f,a,m);l=vec3.distance(e.origin,f);if(l>t)return!1;if(!h)return!0;k.octree||(k.octree=new GL.Octree(k));
h=k.octree.testRay(b,c,0,t);if(!h)return!1;f.set(h.hit);vec3.transformMat4(f,f,m);l=vec3.distance(e.origin,f);return l>t?!1:!0}}();f.prototype.setRangeFromSubmesh=function(a){if(void 0!==a&&this.mesh){var b=gl.meshes[this.mesh];if(b&&b.info&&b.info.groups){if(a.constructor===String){for(var c=0;c<b.info.groups.length;++c)if(b.info.groups[c].name==a){a=c;break}if(c===b.info.groups.length)return!1}if(a=b.info.groups[a])this.draw_range[0]=a.start,this.draw_range[1]=a.length}else console.warn("you cannot set the submesh_id while the mesh is not yet loaded")}else this.draw_range=
null};s.prototype._ctor=function(){f.prototype._ctor.call(this);this.mesh="plane";this.size=vec2.fromValues(1,1);this.blend_mode=e.BLEND_ALPHA;this.flags.two_sided=!0;this.flags.depth_test=!1;this.flags.flipX=!1;this.flags.flipY=!1;this.shader="texture_transform";this._angle=0;this.frame=null;this.frames={};this.texture_matrix=mat3.create();this._uniforms.u_texture_matrix=this.texture_matrix};Object.defineProperty(s.prototype,"angle",{get:function(){return this._angle},set:function(a){this._angle=
a;quat.setAxisAngle(this._rotation,e.FRONT,this._angle*DEG2RAD);this._must_update_matrix=!0},enumerable:!0});s.prototype.setSize=function(a,b){this.size[0]=a;this.size[1]=b};s.createFrames=function(a,b,c){c=c||{};var d=0,g=0;a=1/a;for(var e in b)if(c[b[e]]={pos:[d,g],size:[a,a],normalized:!0},d+=a,1<=d&&(d=0,g+=a),1<=g)break;return c};s.prototype.createFrames=function(a,b){s.createFrames(a,b,this.frames)};s.prototype.addFrame=function(a,b,c,d,g,e){this.frames[a]={pos:vec2.fromValues(b,c),size:vec2.fromValues(d,
g),normalized:!!e}};s.prototype.updateTextureMatrix=function(a){mat3.identity(this.texture_matrix);if(!this.texture)return!1;var b=a.textures[this.texture];if(!b&&a.autoload_assets){var c=this;-1!=this.texture.indexOf(".")&&a.loadTexture(this.texture,a.default_texture_settings,function(a){a&&c.setSize(a.width,a.height)});b=gl.textures.white}if(!b)return!1;a=this.texture_matrix;var d=this.frames[this.frame];if(null!==this.frame&&!d)return!1;if(!d)return this.flags.flipX&&(l[0]=this.flags.flipX?1:0,
l[1]=0,mat3.translate(a,a,l),l[0]=this.flags.flipX?-1:1,l[1]=1,mat3.scale(a,a,l)),!0;if(d.normalized)l[0]=this.flags.flipX?d.pos[0]+d.size[0]:d.pos[0],l[1]=1-d.pos[1]-d.size[1],mat3.translate(a,a,l),l[0]=d.size[0]*(this.flags.flipX?-1:1),l[1]=d.size[1];else{var g=b.height;l[0]=(this.flags.flipX?d.pos[0]+d.size[0]:d.pos[0])/b.width;l[1]=(g-d.pos[1]-d.size[1])/g;mat3.translate(a,a,l);l[0]=d.size[0]*(this.flags.flipX?-1:1)/b.width;l[1]=d.size[1]/b.height}mat3.scale(a,a,l);return!0};s.prototype.render=
function(a,b){this.texture&&this.updateTextureMatrix(a)&&(this.billboard_mode?e.Billboard.orientNode(this,b,a):(mat4.scale(this._global_matrix,this._global_matrix,[this.size[0],this.size[1],1]),a.setModelMatrix(this._global_matrix)),a.renderNode(this,a,b))};extendClass(s,f);e.Sprite=s;e.Scene=u;u.prototype.clear=function(){this._root=new e.SceneNode;this._root._scene=this;this.time=0};u.prototype.getNodeById=function(a){return this._nodes_by_id[a]};u.prototype.update=function(a){this.time+=a;this._root.propagate("update",
[a]);this.destroyPendingNodes()};u.prototype.destroyPendingNodes=function(a){if(this._to_destroy.length)for(a=null;a=this._to_destroy.pop();)a._parent&&a._parent.removeChild(a)};Object.defineProperty(u.prototype,"root",{get:function(){return this._root},set:function(a){throw"Cannot set root of scene";},enumerable:!1});u.prototype.testRay=function(a,b,c,d,g){u._ray_tested_objects=0;b||(b=q);return this.root.testRay(a,b,c,void 0===d?255:d,g)};e.Renderer=k;k.prototype.setDataFolder=function(a){a?(this.assets_folder=
a,"/"!=this.assets_folder.substr(-1)&&(this.assets_folder+="/")):this.assets_folder=""};k.prototype.clear=function(a){a?this.gl.clearColor(a[0],a[1],a[2],3<=a.length?a[3]:1):this.gl.clearColor(0,0,0,0);this.gl.clear(gl.COLOR_BUFFER_BIT|gl.DEPTH_BUFFER_BIT)};k._sort_by_dist_func=function(a,b){return b._distance-a._distance};k._sort_by_priority_func=function(a,b){return b.render_priority-a.render_priority};k._sort_by_priority_and_dist_func=function(a,b){var c=b.render_priority-a.render_priority;return 0!=
c?c:b._distance-a._distance};k.prototype.render=function(a,b,c,d){void 0===d&&(d=255);if(!a)throw"Renderer.render: scene not provided";if(this._current_scene)throw this._current_scene=null,"Cannot render an scene while rendering an scene";this._current_scene=a;b=b||a.camera;if(!b)throw"Renderer.render: camera not provided";A.gl=this.gl;this._state=[];this._meshes_missing=0;this.enableCamera(b);this._nodes.length=0;c||a._root.getVisibleChildren(this._nodes,d);c=c||this._nodes;if(c.length){this._uniforms.u_time=
a.time;this.sort_by_distance&&c.forEach(function(a){a._distance=a.getDistanceTo(b._position)});var g=this;c=c.filter(function(a){return!a.mustRender||!1!=a.mustRender(g,b)});this.sort_by_distance&&this.sort_by_priority?c.sort(e.Renderer._sort_by_priority_and_dist_func):this.sort_by_priority?c.sort(e.Renderer._sort_by_priority_func):this.sort_by_distance&&c.sort(e.Renderer._sort_by_dist_func);a._root.preRender&&a._root.preRender(this,b);for(var p=0;p<c.length;++p){var f=c[p];f.updateGlobalMatrix(!0);
f.preRender&&f.preRender(this,b)}for(p=0;p<c.length;++p)f=c[p],!1!==f.flags.visible&&f.layers&d&&(!this.mustRenderNode||!1!==this.mustRenderNode(f,b))&&(this.setModelMatrix(f._global_matrix),f.render?f.render(this,b):this.renderNode(f,b),this.draw_calls+=1);a._root.postRender&&a._root.postRender(this,b);for(p=0;p<c.length;++p)f=c[p],f.postRender&&f.postRender(this,b)}a.frame++;this.frame++;this._current_scene=null};k.prototype.enableCamera=function(a){this._camera=a;a.updateMatrices();a.extractPlanes();
...
!1;b&&b(a)})};k.prototype.compileShadersFromAtlas=function(a,b){var c=a.shaders;if(c){for(var d in a)a[d]=GL.Shader.expandImports(a[d],a);c=c.split("\n");for(d in c){var g=c[d].trim().split(" "),e=g[0].trim();if("//"!=e.substr(0,2)){var f=a[g[1]],h=a[g[2]],m=null;2<g.length&&(m=g.slice(3).join(" "));if(g[1]&&"@"==g[1][0]){var k=g[1].substr(1)+"_VERTEX_SHADER";GL.Shader[k]&&(f=GL.Shader[k])}g[2]&&"@"==g[2][0]&&(k=g[2].substr(1)+"_FRAGMENT_SHADER",GL.Shader[k]&&(h=GL.Shader[k]));if(m)try{m=JSON.parse(m)}catch(l){console.error("Error in shader macros: ",
e,m,l)}if(m&&b){k={};for(d in m)k[d]=m[d];for(d in b)k[d]=b[d];m=k}else b&&(m=b);try{f&&h?this.shaders[e]?this.shaders[e].updateShader(f,h,m):this.shaders[e]=new GL.Shader(f,h,m):console.warn("Shader subfile not found: ",g[1],g[2])}catch(n){GL.Shader.dumpErrorToConsole(n,f,h)}}}}else console.warn("No 'shaders' found in shaders file atlas, check documentation")};k.prototype.setShadersFromFile=function(a){a=GL.processFileAtlas(a);this.compileShadersFromAtlas(a)};e.sortByDistance=function(a,b){a.forEach(function(a){a._distance=
a.getDistanceTo(b)});a.sort(function(a,b){return b._distance-a._distance})};e.noBlending=function(a){return a.blend_mode===e.BLEND_NONE};e.generateTextureAtlas=function(a,b,c,d,g){b=b||1024;c=c||1024;d=d||64;var e=0,f;for(f in a)e++;gl.disable(gl.DEPTH_TEST);gl.disable(gl.CULL_FACE);gl.disable(gl.BLEND);var e=new GL.Texture(b,c),h={width:b,height:c,size:d,files:{}},k=0,l=0,n={};e.drawTo(function(){for(var e in a)if(":"!=e[0]&&"white"!=e&&"black"!=e&&"notfound"!=e){var f=a[e];if(!f.is_preview&&f.texture_type==
gl.TEXTURE_2D){if(g){var p=f.toBase64().hashCode();if(n[p]){h.files[e]=h.files[n[p]];continue}n[p]=e}h.files[e]={x:k,y:l};f.renderQuad(k,l,d,d);k+=d;if(k==b&&(k=0,l+=d,l==c)){console.warn("Atlas too small, some textures wont be stored.");break}}}});e.info=h;console.log(h);return e};k.prototype.computeResourcesLoaded=function(a){var b=0,c;for(c in a){var d=a[c],g=this.textures[d];g&&!1===g.ready||(d=this.meshes[d])&&!1===d.ready||(g||d)&&b++}return b};Object.defineProperty(k.prototype,"meshes",{get:function(){return this.gl.meshes},
...
vec3.unproject(g,g,this._viewprojection_matrix,c):vec3.copy(g,this.position);var f=d.direction;vec3.set(f,a,b,1);vec3.unproject(f,f,this._viewprojection_matrix,c);vec3.sub(f,f,g);vec3.normalize(f,f);return d};h.prototype.getRayPlaneCollision=function(a,b,c,d,g,e){g=g||vec3.create();a=this.getRay(a,b,e);return geo.testRayPlane(a.origin,a.direction,c,d,g)?g:null};h.controller_keys={forward:"UP",back:"DOWN",left:"LEFT",right:"RIGHT"};h.prototype.applyController=function(a,b,c){c=c||10;a&&(gl.keys[h.controller_keys.forward]?
this.moveLocal(vec3.scale(q,e.FRONT,a*c)):gl.keys[h.controller_keys.back]&&this.moveLocal(vec3.scale(q,e.BACK,a*c)),gl.keys[h.controller_keys.left]?this.moveLocal(vec3.scale(q,e.LEFT,a*c)):gl.keys[h.controller_keys.right]&&this.moveLocal(vec3.scale(q,e.RIGHT,a*c)));b&&(b.deltax&&this.rotate(-0.005*b.deltax,e.UP),b.deltay&&this.rotateLocal(-0.005*b.deltay,e.RIGHT))};h.prototype.lerp=function(a,b){vec3.lerp(this._position,a._position,b);vec3.lerp(this._target,a._target,b);vec3.lerp(this._up,a._up,b);
this._fov=this._fov*(1-b)+a._fov*b;this._must_update_matrix=!0};h.prototype.extractPlanes=function(){function a(a){var b=c.subarray(a,a+3),b=vec3.length(b);0!==!b&&(b=1/b,c[a]*=b,c[a+1]*=b,c[a+2]*=b,c[a+3]*=b)}var b=this._viewprojection_matrix,c=this._planes_data||new Float32Array(24);c.set([b[3]-b[0],b[7]-b[4],b[11]-b[8],b[15]-b[12]],0);a(0);c.set([b[3]+b[0],b[7]+b[4],b[11]+b[8],b[15]+b[12]],4);a(4);c.set([b[3]+b[1],b[7]+b[5],b[11]+b[9],b[15]+b[13]],8);a(8);c.set([b[3]-b[1],b[7]-b[5],b[11]-b[9],
b[15]-b[13]],12);a(12);c.set([b[3]-b[2],b[7]-b[6],b[11]-b[10],b[15]-b[14]],16);a(16);c.set([b[3]+b[2],b[7]+b[6],b[11]+b[10],b[15]+b[14]],20);a(20);this._planes_data=c;this._frustrum_planes||(this._frustrum_planes=[c.subarray(0,4),c.subarray(4,8),c.subarray(8,12),c.subarray(12,16),c.subarray(16,20),c.subarray(20,24)])};var D=e.CLIP_INSIDE=0,n=e.CLIP_OUTSIDE=1,C=e.CLIP_OVERLAP=2;h.prototype.testBox=function(a,b){this._frustrum_planes||this.extractPlanes();var c=this._frustrum_planes,d=0,e=0,d=z(c[0],
...
d>=-b&&d<=b&&(e=!0);d=y(c[4],a);if(d<-b)return n;d>=-b&&d<=b&&(e=!0);d=y(c[5],a);if(d<-b)return n;d>=-b&&d<=b&&(e=!0);return e?C:D};e.Factory=function(a,b,c){a=e.Factory.templates[a];var d=new e.SceneNode;a&&d.configure(a);b&&(b.cosntructor===e.Scene?b.root:b).addChild(d);c&&d.configure(c);return d};e.Factory.templates={grid:{mesh:"grid",primitive:GL.LINES,color:[0.5,0.5,0.5,0.5],blend_mode:e.BLEND_ALPHA},mesh:{shader:"phong"},sphere:{mesh:"sphere",shader:"phong"},floor:{mesh:"planeXZ",scaling:10,
shader:"phong"}};e.parseTextConfig=function(a){function b(a,e){for(var f=c.shift();f;)if(0==f.trim().length)f=c.shift();else{for(var h=0;"\t"==f[h]&&h<f.length;)h++;if(h<e)break;var k={children:[]};try{var m=f.trim();-1!=m.indexOf(":")&&(m="{"+m+"}");var l=new Function("return "+m);k.data=l()}catch(n){console.error(n)}h>=e&&(a&&a.children.push(k),f=b(k,h+1))}return f}var c=a.split("\n");a={data:"",children:[]};b(a,0);return a};k.prototype.createShaders=function(){this._flat_shader=new GL.Shader("\t\t\t\tprecision highp float;\t\t\t\tattribute vec3 a_vertex;\t\t\t\tuniform mat4 u_mvp;\t\t\t\tvoid main() {\t\t\t\t\tgl_Position = u_mvp * vec4(a_vertex,1.0);\t\t\t\t\tgl_PointSize = 2.0;\t\t\t\t}\t\t\t\t",
...
extendClass(r,f);e.Billboard=r;r.SPHERIC=1;r.PARALLEL_SPHERIC=2;r.CYLINDRIC=3;r.PARALLEL_CYLINDRIC=4;r.prototype._ctor=function(){this.billboard_mode=r.SPHERIC;this.auto_orient=!0;f.prototype._ctor.call(this)};r.orientNode=function(a,b,c){if(a.billboard_mode==r.CYLINDRIC||a.billboard_mode==r.PARALLEL_CYLINDRIC){var d=null;a.billboard_mode==r.CYLINDRIC?(d=a.getGlobalPosition(E),vec3.sub(q,b._position,d),l[0]=q[0],l[1]=q[2]):(l[0]=b._front[0],l[1]=b._front[2]);b=vec2.computeSignedAngle(l,e.FRONT2D);
isNaN(b)||(mat4.rotateY(B,G,-b),a._global_matrix.set(B),mat4.setTranslation(a._global_matrix,a._position),mat4.scale(a._global_matrix,a._global_matrix,a._scale))}else a.billboard_mode==r.PARALLEL_SPHERIC?(a._global_matrix.set(b._model_matrix),mat4.setTranslation(a._global_matrix,a._position)):(mat4.lookAt(a._global_matrix,a._position,b.position,e.UP),mat4.invert(a._global_matrix,a._global_matrix)),mat4.scale(a._global_matrix,a._global_matrix,a._scale);c.setModelMatrix(a._global_matrix)};r.prototype.render=
