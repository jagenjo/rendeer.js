...
this.max_points);this._meshes={};this._last_point_id=this._accumulated_time=0}function p(){this._ctor();this.particles=[];this.max_particles=1E3;this.draw_range=[0,3*this.max_particles];this.shader="particles";this.textures={color:"white"};this.flags.blend=!0;this.flags.depth_write=!1;this._render_priority=20;this.num_textures=1;this.particles_size=100;this.particles_life=this.particles_per_second=5;this.particles_damping=0.5;this.particles_acceleration=vec3.create();this.velocity_variation=this.particles_end_scale=
this.particles_start_scale=1;this.emissor_direction=vec3.fromValues(0,1,0);this._uniforms={u_pointSize:this.particle_size,u_scaleStartEnd:vec2.fromValues(1,1),u_texture_info:vec2.fromValues(1,1)};this.primitive=gl.POINTS;this._vertices=new Float32Array(3*this.max_particles);this._extra=new Float32Array(3*this.max_particles);this._meshes={};this._last_particle_id=this._accumulated_time=0}function u(){this._root=new e;this._root._scene=this;this.time=0}function n(a){var b=this.gl=this.context=a;if(!b||
!b.enable)throw"litegl GL context not found.";a!=m.gl&&b.makeCurrent();this.point_size=5;this.sort_by_priority=!0;this._view_matrix=mat4.create();this._projection_matrix=mat4.create();this._viewprojection_matrix=mat4.create();this._mvp_matrix=mat4.create();this._model_matrix=mat4.create();this._nodes=[];this._uniforms={u_view:this._view_matrix,u_viewprojection:this._viewprojection_matrix,u_model:this._model_matrix,u_mvp:this._mvp_matrix};m.gl=this.gl;this.canvas=b.canvas;b.meshes={};b.meshes.plane=
GL.Mesh.plane({size:1});b.meshes.planeXZ=GL.Mesh.plane({size:1,xz:!0});b.meshes.cube=GL.Mesh.cube({size:1});b.textures={};b.textures.notfound=this.default_texture=new GL.Texture(1,1,{filter:b.NEAREST,pixel_data:new Uint8Array([0,0,0,255])});b.textures.white=this.default_texture=new GL.Texture(1,1,{filter:b.NEAREST,pixel_data:new Uint8Array([255,255,255,255])});b.shaders={};this.createShaders()}function f(a){this.type=f.PERSPECTIVE;this._position=vec3.fromValues(0,100,100);this._target=vec3.fromValues(0,
0,0);this._up=vec3.fromValues(0,1,0);this.near=0.1;this.far=1E4;this.aspect=1;this.fov=45;this.frustum_size=50;this._view_matrix=mat4.create();this._projection_matrix=mat4.create();this._viewprojection_matrix=mat4.create();this._model_matrix=mat4.create();this._must_update_matrix=!1;this._top=vec3.create();this._right=vec3.create();this._front=vec3.create();a&&(a.position&&this._position.set(a.position),a.target&&this._target.set(a.target),a.up&&this._up.set(a.up),a.near&&(this.near=a.near),a.far&&
(this.far=a.far),a.fov&&(this.fov=a.fov),a.aspect&&(this.aspect=a.aspect));this.updateMatrices()}function r(a,b){return vec3.dot(a,b)+a[3]}function s(a,b){var c=a.subarray(0,3),d=a[3],g=vec3.fromValues(Math.abs(b.halfsize[0]*c[0]),Math.abs(b.halfsize[1]*c[1]),Math.abs(b.halfsize[2]*c[2])),g=g[0]+g[1]+g[2],c=vec3.dot(c,b.center)+d;return c<=-g?h:c<=g?w:x}var k=m.RD={};k.ZERO=vec3.fromValues(0,0,0);k.RIGHT=vec3.fromValues(1,0,0);k.UP=vec3.fromValues(0,1,0);k.FRONT=vec3.fromValues(0,0,1);k.WHITE=vec3.fromValues(1,
1,1);k.BLACK=vec3.fromValues(0,0,0);k.setup=function(a){a=a||{};if(k.configuration)throw"already called setup";k.configuration=a};var z=0,y=mat4.create();vec3.create();var t=vec3.create();vec3.create();var v=quat.create();m.SceneNode=k.SceneNode=e;e.prototype._ctor=function(){this._uid=z++;this._position=vec3.create();this._rotation=quat.create();this._scale=vec3.fromValues(1,1,1);this._local_matrix=mat4.create();this._global_matrix=mat4.create();this._must_update_matrix=!1;this._render_priority=
10;this._color=vec4.fromValues(1,1,1,1);this._uniforms={u_color:this._color,u_color_texture:0};this.flags={};this.mesh=null;this.textures={};this.children=[]};Object.defineProperty(e.prototype,"position",{get:function(){return this._position},set:function(a){this._position.set(a);this._must_update_matrix=!0},enumerable:!0});Object.defineProperty(e.prototype,"positionX",{get:function(){return this._position[0]},set:function(a){this._position[0]=a;this._must_update_matrix=!0},enumerable:!0});Object.defineProperty(e.prototype,
"positionY",{get:function(){return this._position[1]},set:function(a){this._position[1]=a;this._must_update_matrix=!0},enumerable:!0});Object.defineProperty(e.prototype,"positionZ",{get:function(){return this._position[2]},set:function(a){this._position[2]=a;this._must_update_matrix=!0},enumerable:!0});Object.defineProperty(e.prototype,"rotation",{get:function(){return this._rotation},set:function(a){this._rotation.set(a);this._must_update_matrix=!0},enumerable:!0});Object.defineProperty(e.prototype,
"color",{get:function(){return this._color},set:function(a){this._color.set(a)},enumerable:!0});Object.defineProperty(e.prototype,"opacity",{get:function(){return this._color[3]},set:function(a){this._color[3]=a},enumerable:!0});Object.defineProperty(e.prototype,"scene",{get:function(){return this._scene},set:function(a){throw"cannot set scene, add to root node";},enumerable:!0});Object.defineProperty(e.prototype,"parentNode",{get:function(){return this._parent},set:function(a){throw"Cannot set parentNode of GameObject";
},enumerable:!1});e.prototype.addChild=function(a){function b(a,d){a._scene=d;for(var g in a.children)b(a.children[g],d)}if(a._parent)throw"addChild: Cannot add a child with a parent, remove from parent first";a._parent=this;this.children.push(a);b(a,this._scene)};e.prototype.removeChild=function(a){function b(a){a._scene=null;for(var c in a.children)b(a.children[c])}if(a._parent!=this)throw"removeChild: Not its children";var c=this.children.indexOf(a);if(-1==c)throw"removeChild: impossible, should be children";
this.children.splice(c,1);a._parent=null;b(a)};e.prototype.getAllChildren=function(a){a=a||[];for(var b in this.children){var c=this.children[b];a.push(c);c.getAllChildren(a)}return a};e.prototype.serialize=function(){var a={position:[this._position[0],this._position[1],this._position[2]],rotation:[this._rotation[0],this._rotation[1],this._rotation[2],this._rotation[3]],scale:[this._scale[0],this._scale[1],this._scale[2]],children:[]},b;for(b in this.children)a.children.push(this.children[b].serialize());
